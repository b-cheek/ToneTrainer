...
const ExercisePlayer = forwardRef<WebView, { soundScript: string; onLoadEnd: () => void }>((props, ref) => {
    ...
    return (
        <View>
            ...
            <AudioPlayer ref={webview} soundScript={props.soundScript} onLoadEnd={props.onLoadEnd} />
        </View>
    )
});
